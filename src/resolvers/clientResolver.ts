...
export const clienteResolvers = {
  ...
  Mutation: {
    ...
    createCliente: async (_: any, { nombre, apellido, ci, telefono, direccion, email }: { nombre: string, apellido: string, ci: string, telefono: string, direccion: string, email: string }) => {
      const newCliente = await createCliente(nombre, apellido, ci, telefono, direccion, email);
    ...
    updateCliente: async (_: any, { id, nombre, apellido, ci, telefono, direccion, email }: { id: number, nombre?: string, apellido?: string, ci?: string, telefono?: string, direccion?: string, email?: string }) => updateCliente(id, nombre, apellido, ci, telefono, direccion, email),
