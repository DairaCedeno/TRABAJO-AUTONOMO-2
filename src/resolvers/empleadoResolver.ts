...
export const empleadoResolvers = {
  ...
  Mutation: {
    ...
    createEmpleado: async (_: any, { nombre, apellido, CI, telefono, direccion }: { nombre: string, apellido: string, CI: string, telefono: string, direccion: string }) => {
      const newEmpleado = await createEmpleado(nombre, apellido, CI, telefono, direccion);
    ...
    updateEmpleado: async (_: any, { id, nombre, apellido, CI, telefono, direccion }: { id: number, nombre?: string, apellido?: string, CI?: string, telefono?: string, direccion?: string }) => updateEmpleado(id, nombre, apellido, CI, telefono, direccion),
